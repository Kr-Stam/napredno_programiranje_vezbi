...
public class ZonedDateTimeTest {
    ...
    static ZonedDateTime zonedDateTimeOf() {
         ...
         */
        return ZonedDateTime.of(LocalDateTime.parse("2015-07-10T02:14:25.000"), ZoneId.of("Asia/Tokyo"));
    }
    ...
    static ZonedDateTime sameLocalAs() {
         ...
         */
        return zdt.toLocalDateTime().atZone(ZoneId.of("America/Los_Angeles"));
    }
