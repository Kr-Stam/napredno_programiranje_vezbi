...
class Queue<T>{
    ...
    public void enqueue(T element){
        Node<T> tmp = new Node<>(element, null);
        if(!isEmpty())
            elements.getLast().setNext(tmp);
    ...
    public T dequeue() throws EmptyQueueException {
        ...
        return elements.removeFirst().getElement();
    }
    ...
    public T inspect() throws EmptyQueueException {
        if(isEmpty())
            throw new EmptyQueueException();
        return elements.getLast().getElement();
    }
